...
public:
  ...
  {
    return providedBasicPorts( // 来自于基类 BtActionNode
      {
        BT::InputPort<double>("backup_dist", 0.15, "Distance to backup"), // 创建一个类型为 double 的输入端口，名为 "backup_dist"，默认值为 0.15，描述信息为 "Distance to backup"
